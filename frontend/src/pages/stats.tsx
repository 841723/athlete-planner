  ...
  return (
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <CumulativeChart sessions={completed} />
        <VolumeEvolutionChart sessions={completed} />
        <DistanceChart sessions={completed} />
        <HoursChart sessions={completed} />
        <TrainingLoadChart sessions={completed} />
        <PaceChart sessions={completed} />
        <SpeedChart sessions={completed} />
        <SwimTimeChart sessions={completed} />
      </div>
    </div>
  );
}
